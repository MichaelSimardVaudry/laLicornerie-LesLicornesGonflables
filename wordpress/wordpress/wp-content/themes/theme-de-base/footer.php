        ...
        <div class="row">
            ...
            <div class="col-1" id="partenaire">
                ...
                <?php
                   ...
                   while ($logo->have_posts()) : $logo->the_post(); 
                   ?>
                <img src="<?php the_field('partenaire1'); ?>" class="partenaires">
                <img src="<?php the_field('partenaire2'); ?>" class="partenaires">
                <img src="<?php the_field('partenaire3'); ?>" class="partenaires">
                <?php
                    endwhile; 
                    wp_reset_postdata(); 
                ?>
